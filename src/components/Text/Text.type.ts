...
import type { ThemeType } from 'react-native-palta-ui';
import type { ViewProps } from '../Box/Box.type';

export interface ITextProps extends RNTextProps, ViewProps {
  variant: keyof ThemeType['text'] | string;
